...
So, I dived back to Jekyll templates. My needs always have been simple, it is an online CV, a redundant *LinkedIn* if you may. The search was not long, I settled on one clean variation of it. It was made originally by **Xiaoying Riley** at [3rd Wave Media](http://themes.3rdwavemedia.com/ "3rd Wave Media @ Web") *<[@3rdwave_themes](https://twitter.com/3rdwave_themes "3rd Wave Media @ Twitter")>*, then [forked](https://github.com/sharu725/online-cv "online-cv @Github") for Jekyll use by **Sharath Kumar** at [Webjeda](https://webjeda.com "Webjeda @ Web") *<[@webjeda](https://twitter.com/webjeda "Webjeda @ Twitter")>*. So, Kudos to both.
