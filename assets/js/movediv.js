...
function moveDiv() {
  if (mediaQuery.matches) {
    ...
    if (!existingHeader) {
      ...
      header.innerHTML =
        '<h3 style="font-weight: 500;"><span class="fa-stack fa-xs" style="margin-right: 5px;"> <i class="fas fa-circle fa-stack-2x"></i> <i class="fas fa-headphones fa-stack-1x fa-inverse" style="color: #374e59;"></i> </span>INTERESTS</h3>';
